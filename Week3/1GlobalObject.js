//In JavaScript ther is something called the global object
x = 2;
console.log(x);
//Why does this work?
...
//Any method or libraries we have been using so far
...
//notice what happens - do not declare variables by adding them to the window
innerHeight = 10;
console.log(window.innerHeight);
