...
let student1 = {
    ...
    calculateAvgGrade: function(){
        ...
        let total = 0;
        //if you are inside a function and need to access one of
...
//I can log individual properties just like in C#
...
student3.set("studentId", 23490873);
...
//How do I call calculateAvgGrade?
let average = student3.get("calculateAvgGrade")();
console.log(average);
//we can use and object as a key
