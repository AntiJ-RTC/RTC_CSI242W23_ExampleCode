...
//when you are starting out with JS, just use children
console.log(groceryList.children);
//It's kind of like an array, except that you can't foreach it
...
//in order to make a button do something, I add and eventListener to it
...
function addElementToList(){
    ...
    //you can get the elements and access its properties in one line
